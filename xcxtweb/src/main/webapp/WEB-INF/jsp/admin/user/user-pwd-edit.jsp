...
<body>
	<div class="page-container">
		<form action="/admin/user/updatePwd.do" class="form form-horizontal"
			method="post" id="form">
			<input type="hidden" id="id" name="id" value="${id }" />
			<div class="row cl">
				<label class="form-label col-xs-2 col-sm-2">原密码：</label>
				<div class="formControls col-xs-8 col-sm-8">
					<input datatype="*" maxlength="30" id="oldPassword"
						name="oldPassword" placeholder="请输入原密码" class="input-text"
						type="password" />
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-8">
					<input datatype="*" maxlength="30" id="newPassword"
						name="newPassword" placeholder="请输入新密码" class="input-text"
						type="password" />
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-8">
					<input datatype="*" maxlength="30" id="confirmPassword"
						name="confirmPassword" placeholder="请再次输入密码" class="input-text"
						type="password" />
				</div>
			</div>
			<div class="row cl">
