...
<div class="page-container" >
	<form action="/admin/foodCategory/save.do" class="form form-horizontal" method="post" id="form">
	<input type="hidden" id="parentId" name="parentId" value="${parentId }" />
	<input type="hidden" id="id" name="id" value="${foodCategory.id }" />
	<input type="hidden" id="isChild" name="isChild" value="${isChild }" />
	<div class="row cl">
		<label class="form-label col-xs-2 col-sm-2">菜品分类：</label>
		<div class="formControls col-xs-8 col-sm-8">
		<input datatype="*" maxlength="30" id="name" name="name" value="${foodCategory.name }" placeholder="请输入菜品分类" class="input-text" type="text" />
		</div>
	</div>
	<div class="row cl">
