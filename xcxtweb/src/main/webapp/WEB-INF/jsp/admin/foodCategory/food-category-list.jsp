				...
				"success" : function(data) {
					if(data && data.status==1){
						...
						for(var i = 0; i<data.result.length; i++){
							...
							html += "<a href='javascript:Data.editChild(\""+id+"\");' >编辑下级分类</a>";
							html += "</td>";
							html += "</tr>";
						}
// 						alert(html);
		...
		"edit":function(id){
			...
			layer.open({
		      ...
		      area: ['600px', '400px'],
		        ...
		        maxmin: true,
		        shade: false,
		      content: '/admin/foodCategory/toEdit.do?id='+id
		    });
		},
		"editChild":function(parentId){
			var index = layer.open({
		      ...
		      area: ['600px', '400px'],
		        ...
		        maxmin: true,
		        shade: false,
		      content: '/admin/foodCategory/list.do?parentId='+parentId
		    });
			layer.full(index);
		},
