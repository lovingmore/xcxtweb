...
<header class="navbar-wrapper">
  <div class="navbar navbar-fixed-top">
    <div class="container-fluid cl">
      ...
      <nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs" style="right:40px">
        <ul class="cl">
...
<aside class="Hui-aside" style="padding-top:0">
  <div id="info" class="menu_dropdown bk_2">
  	<c:forEach var="menu" items="${menus }">
  		<dl>
	      <dt class="">
	        <i class="Hui-iconfont Hui-iconfont-userid"></i> ${menu.name }<i class="Hui-iconfont menu_dropdown-arrow Hui-iconfont-arrow2-bottom"></i>
	      </dt>
	      <dd>
	      <c:forEach items="${menu.cmenus }" var="cmenu">
	        <ul>
	          <li><a id="a_default" _href="${cmenu.url }" data-title="${cmenu.name }" href="javascript:void(0)">${cmenu.name }</a></li>
	        </ul>
	      </c:forEach>
	      </dd>
	    </dl>
