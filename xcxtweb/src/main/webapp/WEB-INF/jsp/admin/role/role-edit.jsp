...
<div class="page-container" >
	<form action="/admin/role/save.do" class="form form-horizontal" method="post" id="form">
	<input type="hidden" id="id" name="id" value="${role.id }" />
	<div class="row cl">
		<label class="form-label col-xs-2 col-sm-2">角色名称：</label>
		<div class="formControls col-xs-8 col-sm-8">
		<input datatype="*" maxlength="30" id="name" name="name" value="${role.name }" placeholder="请输入角色名称" class="input-text" type="text" />
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-2 col-sm-2">备注：</label>
		<div class="formControls col-xs-8 col-sm-8">
		<textarea class="textarea" id="remark" name="remark">${role.remark }</textarea>
		</div>
	</div>
	<div class="row cl">
