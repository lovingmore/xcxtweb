...
<body>
	<div class="pd-20">
		<form action="/admin/role/list.do" method="post" id="form">
	...
	var Data = {
		"get" : function(pageId,searchKey){
			...
			var url = "/admin/role/listAjax.do";
			$.ajax({
				"url" : url,
				"data" : {
					"pageId" : pageId,
				...
				"success" : function(data) {
					if(data && data.status==1){
						...
						for(var i = 0; i<data.result.length; i++){
							...
							var remark = data.result[i].remark == null ? "" : data.result[i].remark;
							...
							html += "<td class='col1'>" + remark + "</td>";
							html += "<td class='col1'><a href='javascript:Data.allotMenu(\""+id+"\");' >分配菜单</a></td>";
							html += "</tr>";
						}
// 						alert(html);
						$("#dataTable").html(html);
		...
		"edit":function(id){
			...
			layer.open({
		      ...
		      area: ['600px', '350px'],
		        ...
		        maxmin: true,
		        shade: false,
		      content: '/admin/role/toEdit.do?id='+id
		    });
		},
		"allotMenu":function(id){
			layer.open({
		      type: 2,
		      title: "分配菜单",
		      area: ['650px', '600px'],
		        ...
		        maxmin: true,
		        shade: false,
		      content: '/admin/role/allotMenu.do?id='+id
		    });
		},
		"delete": function(){
			if(isSelected(1)){
